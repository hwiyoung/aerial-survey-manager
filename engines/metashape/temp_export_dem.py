...
import os
from common_utils import progress_callback

def export_dem(input_images, image_folder, output_path, run_id, process_mode="Normal", input_epsg="4326", output_epsg="5186"):
    ...
    # Turbo 컬러맵 데이터 파일 읽기
    with open("/home/innopam/Project-after-2025/airflow-metaShape/dags/metashape/turbo_colormap.txt", "r") as f:
        for line in f:
...
def main():
    ...
    # build_dem 함수 실행
    export_dem("a", "b", "/home/innopam/Project-after-2025/reai-monorepo/.outputs/105", "c", "d")
