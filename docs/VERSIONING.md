...
현재 운영 검증 후보는 `v2.1.0-rc.5`입니다. 사용자 승인 전에는 정식
`v2.1.0` 태그를 만들지 않습니다.
...
git commit -m "chore(release): prepare v2.1.0-rc.5"
git tag -a v2.1.0-rc.5 -m "Aerial Survey Manager v2.1.0-rc.5"
git push origin develop
git push origin v2.1.0-rc.5
...
```text
aerial-survey-manager-v2.1.0-rc.5.tar.gz
```
